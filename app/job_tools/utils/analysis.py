...
def check_analysis_config(path):
    """
    ...
    config_params = parse_analysis_config(path)
    if isinstance(config_params, str):
        err_msg = config_params
    else:
        err_msg = check_dge_analysis_parameters(config_params)
...
def check_dge_analysis_parameters(config_parameters):
    ...
    status_msg = ""
    param_names_invalid = check_dge_analysis_parameter_names(config_parameters)

    if param_names_invalid:
        status_msg = param_names_invalid
    else:
