...
* @returns {any}
*/
export function prerank_rs(genes, metric, gene_sets, weight, min_size, max_size, nperm, seed) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(genes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF64ToWasm0(metric, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.prerank_rs(retptr, ptr0, len0, ptr1, len1, addHeapObject(gene_sets), weight, min_size, max_size, nperm, seed);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('gsea_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
